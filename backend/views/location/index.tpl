	        ...
	        <table class="table table-striped jambo_table bulk_action">
	          ...
	          <tbody>
	            ...
	            <tr class="even pointer">
	              ...
	              <td class=" last">
	              	<a href='{url route="location/edit" id=$model->getId()}' class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>

	              	<a href='{url route="location/change-visible" id=$model->getId()}' class="btn btn-primary btn-xs" action="visible-status">
	              		{if $model->isVisible()}
	              		<i class="fa fa-eye"></i>
	              		{else}
